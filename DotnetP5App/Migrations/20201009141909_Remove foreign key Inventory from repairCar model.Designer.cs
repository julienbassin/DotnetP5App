...
namespace DotnetP5App.Migrations
{
    ...
    [Migration("20201009141909_Remove foreign key Inventory from repairCar model")]
    partial class RemoveforeignkeyInventoryfromrepairCarmodel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotnetP5App.Models.Inventory", b =>
                {
                    ...
                    b.HasOne("DotnetP5App.Models.Status", "Status")
                        .WithOne("Inventory")
                        .HasForeignKey("DotnetP5App.Models.Inventory", "StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DotnetP5App.Models.RepairCar", b =>
                {
                    b.HasOne("DotnetP5App.Models.Inventory", null)
                        .WithMany("Repairs")
